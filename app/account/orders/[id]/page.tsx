...
const trackingSteps = [
  ...
  {
    title: "In Transit",
    description: "Your package is currently on its way",
    date: "Sep 12, 2026",
    completed: true,
    current: true,
  },
      ...
      <section className="border-b bg-white">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            ...
            <span className="w-fit rounded-full bg-orange-100 px-4 py-2 text-sm font-medium text-orange-700">
              {order.status}
            </span>
          </div>
        </div>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <div className="mb-4 flex items-center gap-3">
                <div className="rounded-full bg-gray-100 p-2">
                  <CreditCard size={19} className="text-gray-700" />
                </div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <button
                  type="button"
                  className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 transition hover:border-gray-900 hover:text-gray-900"
                >
                  Contact Support
                </button>
